...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='TV360/RCM/save_models/193_best_accuracy.pth', help='initial weights path')
    parser.add_argument('--epochs', type=int, default=500)
    parser.add_argument('--batch-size', type=int, default=2048, help='total batch size for all GPUs, -1 for autobatch')
    parser.add_argument('--device', type=str, default='cuda:0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--output-dir', type=str, default='TV360/RCM/save_models/', help='Save Models Dir')
