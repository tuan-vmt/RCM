...
class GNN(object):
    ...
    """
    def __init__(self, adj_matrix, features=None, labels=None, supervised=False, model='gat', n_layer=2, emb_size=132, random_state=1234, device='auto', epochs=100, batch_size=2, lr=0.7, unsup_loss_type='margin', print_progress=True):
