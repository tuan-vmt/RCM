...
def example_with_cora():
    raw_features_file = '/home/gemai/mnt_raid1/datpt1/Viettel/T11-2022/folder_pickle/raw_features_gnn.pickle'
    ...
    with open("/home/gemai/mnt_raid1/datpt1/Viettel/T11-2022/folder_pickle/score.pickle", 'rb') as f:
    ...
    """
    gnn = GNN(adj_matrix, features=raw_features, supervised=False, model=opt.model, device=opt.device,epochs=opt.epochs, lr=opt.lr, unsup_loss_type=opt.loss, n_layer=opt.layer, emb_size=opt.emb_size)
    # train the model
    gnn.fit()
